...
export async function fetch(url, options = {}) {
	// set options method to 'GET' if no method is provided
  options.method = options.method || 'GET';
	//set options headers to empty obj if no headers are provided
...
//function to be called to get 'XSRF-TOKEN' --only to be used in development
